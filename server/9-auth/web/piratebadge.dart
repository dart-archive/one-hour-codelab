...
// 'http://localhost:8080/'. Since our server is now running on
// port 8080, changed from 8088 since we are using appengine which
// listens on port 8080), the only reason we pass in the url now
// is to override the scheme, e.g. use https if secure, http if not.
// The default is http (also in the generated client stub code).
